...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<MyApiResponse<Object>> handleIllegalArgumentException(
        ...
        return MyApiResponse.error(
                HttpStatus.BAD_REQUEST, "Invalid argument provided", e.getMessage());
    }
    ...
    * */
    ...
    public ResponseEntity<ApiResponse<Object>> handleValidationExceptions(
        ...
        ApiResponse<Object> response =
                new ApiResponse<>(
                        HttpStatus.BAD_REQUEST.toString(), errors, null, "VALIDATION_ERROR");
    ...
    public ResponseEntity<MyApiResponse<Object>> handleResponseStatusException(
        ...
        return MyApiResponse.error(
                (HttpStatus) ex.getStatusCode(), ex.getReason(), ex.getMessage());
    }
}
