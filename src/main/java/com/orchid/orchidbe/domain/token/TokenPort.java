...
public interface TokenPort {
  ...
  record RefreshTokenDTO(@NotBlank(message = "Refresh token is required") String refreshToken) {}
  ...
  record AccessTokenReq(
      @JsonProperty("access_token") @NotBlank(message = "Access token is required")
          String accessToken) {}
}
